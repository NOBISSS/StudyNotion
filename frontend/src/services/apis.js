...
export const adminEndpoints={
    CREATE_CATEGORY_API:BACKEND_URL,
  UPDATE_CATEGORY_API:BACKEND_URL,
  DELETE_CATEGORY_API:BACKEND_URL,
  GET_ALL_CATEGORY_API:BACKEND_URL,
  GET_ALL_USERS_API:BACKEND_URL,
  BAN_USER_API:BACKEND_URL,
  UNBAN_USER_API:BACKEND_URL,
  DELETE_USER_API:BACKEND_URL,
  GET_ALL_COURSES_API:BACKEND_URL,
  TOGGLE_COURSE_API:BACKEND_URL,
  GET_ADMIN_ANALYTICS_API:BACKEND_URL
}
