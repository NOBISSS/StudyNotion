...
export const endPoints = {
  ...
  FORGOT_PASSWORD_RESET_PASSWORD_API:
    BACKEND_URL + "/auth/forgotpassword/reset",
...
export const adminEndpoints = {
  CREATE_CATEGORY_API: BACKEND_URL + "/categories/create",
  UPDATE_CATEGORY_API: BACKEND_URL + "/categories/update/:categoryId",
  DELETE_CATEGORY_API: BACKEND_URL + "/categories/delete/:categoryId",
  GET_ALL_CATEGORY_API: BACKEND_URL + "/categories/getall",
  GET_ALL_USERS_API: BACKEND_URL + "/users/getall",
  BAN_USER_API: BACKEND_URL + "/users/ban",
  UNBAN_USER_API: BACKEND_URL + "/users/unban",
  DELETE_USER_API: BACKEND_URL + "/users/delete",
...
export const courseEndpoints = {
  ...
  INSTRUCTOR_COURSE_DETAILS_API:
    BACKEND_URL + "/courses/getinstructorcourse/:courseId",
...
export const sectionEndpoints = {
  ...
  UNDO_DELETION_SECTION_API:
    BACKEND_URL + "/sections/undolastremoved/:sectionId", //has to be updated while calling
};

//have to check
export const subSectionVideoEndpoints = {
  GET_SUBSECTION_API: BACKEND_URL + "/subsections/getall/:sectionId",
  PUT_MARK_SUBSECTION_COMPLETED_API:
    BACKEND_URL + "/subsections/markcompleted/:subsectionId",
  GET_SUBSECTION_DETAILS_API:
    BACKEND_URL + "/subsections/video/getone/:subsectionId",
...
export const subSectionMaterialEndpoints = {
  ...
  DELETE_MATERIAL_API:
    BACKEND_URL + "/subsections/material/delete/:subsectionId",
};
