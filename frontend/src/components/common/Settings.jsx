...
const Settings = () => {
    ...
    const [passwordData, setPasswordData] = useState({ oldPassword: "", newPassword: "", email: user?.email });
    ...
    return (
      <div className="OUTTER DIV  text-white py-5 pl-7 w-[80vw] overflow-hidden">
        <div className="INNER-DIV flex flex-col gap-10 py-5 px-10">
          <h1 className="text-3xl mb-5 font-semibold">Edit Profile</h1>
          ...
          <div className="flex gap-10 p-8 justify-between h-1/2 bg-[#161D29] rounded-md items-center">
            <div className="ml-5 flex gap-3 items-center">
              ...
              <div className="mx-auto items-center">
                <form>
                  <h3 className="text-[17px] font-sm mb-2">
                  ...
                  <div className="flex flex-row gap-5">
                    <button
                      type="button"
                      className="bg-[#2C333F] px-5.5 py-2 rounded-md text-[#C5C7D4] font-medium cursor-pointer"
                    ...
                    <input
                      ...
                      value={
                        formData.additionalDetails.dateOfBirth
                          ? new Date(formData.additionalDetails.dateOfBirth)
                              .toISOString()
                              .split("T")[0]
                          : new Date()
                      }
          ...
          <div className="bg-[#340019] flex border-[2px] border-[#691432]  lg:pl-12 rounded-md sm:pl-2">
            <div className="w-1/14 mt-8">
              ...
              <svg
                ...
                className="text-3xl text-red-600 bg-red-900 rounded-full w-[50px] h-[50px] p-2.5"
                height="1em"
                width="1em"
            ...
            <div className="lg:-ml-6 flex flex-col p-8 gap-2">
              ...
              <p className="text-[#FBC7D1] lg:w-[55%] font-sm">
                ...
                contain Paid Courses. Deleting your account is permanent and
