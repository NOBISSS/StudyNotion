  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p style={{ color: "#F1F2FF", fontWeight: 700, fontSize: 16 }}>
            Add Review
          </p>
          <button
            onClick={onClose}
        ...
        <div style={{ padding: "24px 24px 22px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", gap: 10 }}>
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = "#AFB2BF";
...
function SidebarSection({
  ...
  const subsCount =
    subs !== null ? subs.length : (section.subSectionIds?.length ?? 0);
              ...
              return (
                <div
                  ...
                  onClick={(e) => {
                    ...
                    onSelectSub(sub, sub.contentType);
                  }}
                  style={{
                    display: "flex",
                ...
                >
                  ...
                  {sub.contentType == "quiz" && (
                    ...
                    >
                      ...
                      <path d="M13 9C13 7.89543 13.8954 7 15 7C16.1046 7 17 7.89543 17 9C17 10.1046 16.1046 11 15 11C14.4477 11 14 10.5523 14 10C14 9.44772 14.4477 9 15 9Z" />
                    </svg>
                  )}
                </div>
              );
  ...
  return (
    ...
    "
          ...
          {activeSubType == "material" && (
            <MaterialViewer
              setCompletedIds={setCompletedIds}
              isCompleted={completedIds.has(videoSrc?.subsectionId)}
              materialSrc={videoSrc}
              setMaterialSrc={setVideoSrc}
              setLoadingMaterial={setLoadingVideo}
              setActiveSub={setActiveSub}
            />
          )}
