                ...
                {q.options.map((opt, i) => (
                    <div key={i} className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`w-5 h-5 rounded-full border-2 shrink-0 transition-all ${q.correctAnswer && q.correctAnswer === opt && opt !== ""
                        ...
                        <input
                            ...
                            className={`${inputCls} flex-1 ${q.correctAnswer === opt && opt !== "" ? "border-[#22C55E]/50" : ""
                                }`}
                        />
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    className={`w-full bg-[#161D29] border ${errors.title ? "border-[#EF4444]" : "border-[#2C333F] focus:border-[#FFD60A]"
