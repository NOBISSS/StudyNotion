      ...
      <div className="bg-[#161D29] rounded-xl p-6 flex flex-col gap-5">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <div className="relative">
            ...
            >
              <option value="" disabled className="bg-[#2C333F]">
                Choose Level
              </option>
              {LEVEL.map((level, index) => (
                <option key={index} value={level} className="bg-[#2C333F]">
                  {level}
                </option>
              ))}
            </select>
            <span className="absolute right-3 top-1/2 -translate-y-1/2 text-[#838894] pointer-events-none text-xs">
              ▾
            </span>
          </div>
          {errors.courseLevel && (
          ...
          <div className="relative">
            ...
            >
              ...
              {courseCategories.map((cat) => (
                <option key={cat._id} value={cat._id} className="bg-[#2C333F]">
                  {cat.name}
                </option>
              ))}
            </select>
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <label
            className={`cursor-pointer ${compressing ? "pointer-events-none opacity-60" : ""}`}
          >
        ...
        <RequirementOfCourse
          ...
          errors={errors}
          setValue={setValue}
          requirements={course?.instructions || []}
        />
      </div>
