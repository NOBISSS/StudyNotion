              ...
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                {course?.thumbnailUrl ? (
                  <img
                    ...
                    className="w-full sm:w-[220px] h-[200px] sm:h-[130px] object-cover rounded-lg shrink-0"
                  />
                ) : (
                ...
                <div className="flex"><div className="flex flex-col gap-1 pt-1">
                  ...
                  <p className="text-[#6E727F] text-xs mt-1">
                    {course?.courseContent?.length ?? "—"} Total Courses &bull;
                    Lesson &bull; Beginner
                  </p>
                </div>
              {/* Right: Remove + Price */}
