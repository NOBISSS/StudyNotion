        ...
        <div>
            <div className='flex flex-row gap-15 items-center'>
                                ...
                                <div key={index}>
                                    ...
                                    </div>
                                    {
                                        ...
                                        <div className='ml-6 mt-3'>
                                            <img src="https://res.cloudinary.com/dc9ukfxel/image/upload/v1774845886/Line_3_bbc3ri.png" alt="" />
                                        </div>
                                    }
                                </div>
                            )
                ...
                <div className='relative shadow-blue-500' >
                    <img src="https://res.cloudinary.com/dc9ukfxel/image/upload/v1774845893/TimelineImage_adpinc.png" alt="TimeLineimg"
