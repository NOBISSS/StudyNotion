        ...
        md:px-[9vw] pt-20 flex flex-col items-center text-center'>
                ...
                <div className='photos mt-10 flex justify-center gap-6 md:h-[200px]'>
                    <img src={getImage("About3_nmyw4k.jpg")} className='w-auto h-[270px] shadow-md'
                        alt="A3" />
                    <img src={getImage("About4_d2ltmb.jpg")} alt="A3" className='w-auto h-[270px] shadow-md' />
                    <img src={getImage("d7ec76d895324e674830d8e2e4340dfc101e16d7_adlwcp.jpg")} alt="A3" className='w-auto h-[270px] shadow-md' />
                </div>
            </div>
            {/**SECTION 2 */}
