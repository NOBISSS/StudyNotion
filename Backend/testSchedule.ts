...
const course = await Course.create({
  ...
  thumbnailUrl: "https://plus.unsplash.com/premium_photo-1670426500778-80d177da0973?q=80&w=856&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // fake URL
});

console.log("Course created:", course._id);

// 2️⃣ Schedule after 1 minute
