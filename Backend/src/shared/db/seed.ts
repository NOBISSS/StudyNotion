...
const sampleGithubOAuthResponse = {
  ...
  following_url:
    "https://api.github.com/users/arafatmansuri/following{/other_user}",
  gists_url: "https://api.github.com/users/arafatmansuri/gists{/gist_id}",
  starred_url:
    "https://api.github.com/users/arafatmansuri/starred{/owner}{/repo}",
  ...
  received_events_url:
    "https://api.github.com/users/arafatmansuri/received_events",
  type: "User",
...
const sampleGoogleOAuthResponse = {
  data: {
    ...
    family_name: "Mansuri",
    picture:
      "https://lh3.googleusercontent.com/a/ACg8ocJrM6TzMclHa2mnjSgqcxvMpGVyYCKQ9_UUxJruMNLmiUVZcI3k=s96-c",
  },
};
