...
export const createQuiz = asyncHandler(async (req, res) => {
    ...
    const { title, description, courseId, sectionId, questions } = parsedQuizData.data;
    ...
    const correctAnswerIds = questionsWithIds.map((q) => {
        const correctOption = q.options.find((o) => o.optionText.toLowerCase() === q.correctAnswer.toLowerCase());
...
export const deleteQuiz = asyncHandler(async (req, res) => {
    ...
    const quiz = await Quiz.findOneAndUpdate({ subSectionId: subsection._id, courseId: subsection.courseId }, { isActive: false });
    if (!quiz) {
...
export const updateQuiz = asyncHandler(async (req, res) => {
    ...
    const questionsWithIds = questions.map((q) => {
        ...
        return {
            ...
            correctAnswer: optionsWithIds.find((o) => o.optionText.toLowerCase() == q.correctAnswer.toLowerCase() ||
                o.optionId.toString() == q.correctAnswer)?.optionId || null,
            points: q.points,
        };
    });
