...
import { deleteAnnouncement, getAnnouncements, makeAnnouncement, markAnnouncementReadOrUnread, updateAnnouncement, } from "./announcementController.js";
...
announcementRouter.post("/markread/:announcementId", markAnnouncementReadOrUnread);
announcementRouter.post("/markunread/:announcementId", markAnnouncementReadOrUnread);
