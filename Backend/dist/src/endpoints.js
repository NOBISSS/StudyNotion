...
export const endpoints = {
    auth: {
        signup: {
            ...
            description: "Register a new user and send OTP to email, then verify OTP to complete registration",
            method: "POST",
        },
        signin: {
        ...
        forgotpassword: {
            ...
            description: "Forgot password and send OTP to email to reset password, then verify OTP to complete password reset",
            method: "POST",
        },
        resendOTP: {
