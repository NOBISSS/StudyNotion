export const studyNotionLogo = "https://res.cloudinary.com/djjqvm5wn/image/upload/v1774373011/logo_hgz270.png";
export const AnnouncementTemp = (title, message, instructorName) => {
    return `<!DOCTYPE html>
  <html lang="en">
  <head>
      <meta charset="UTF-8" />
